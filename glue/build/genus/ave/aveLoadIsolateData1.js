// list the sequences in source ncbi-refseqs-ave
var listSeqResult = glue.command(["list", "sequence", "-w", "source.name = 'ncbi-refseqs-ave'"]);
...
_.each(seqIds, function(seqId) {
    ...
    glue.inMode("sequence/ncbi-refseqs-ave/"+seqId, function() {
