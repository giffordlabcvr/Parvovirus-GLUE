// list the sequences in source ncbi-refseqs-boca
var listSeqResult = glue.command(["list", "sequence", "-w", "source.name = 'ncbi-refseqs-boca'"]);
...
_.each(seqIds, function(seqId) {
    ...
    glue.inMode("sequence/ncbi-refseqs-boca/"+seqId, function() {
