// list the sequences in source ncbi-refseqs-tetra
var listSeqResult = glue.command(["list", "sequence", "-w", "source.name = 'ncbi-refseqs-tetra'"]);
...
_.each(seqIds, function(seqId) {
    ...
    glue.inMode("sequence/ncbi-refseqs-tetra/"+seqId, function() {
