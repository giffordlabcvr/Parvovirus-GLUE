...
var alignments = glue.tableToObjects(glue.command(["list", "alignment", "-w", "name like '%GENUS%'"]));
...
_.each(alignments,function(msaObj){
	...
	var features = glue.tableToObjects(glue.command(["list", "alignment", "-w", "name like '%GENUS%'"]));
