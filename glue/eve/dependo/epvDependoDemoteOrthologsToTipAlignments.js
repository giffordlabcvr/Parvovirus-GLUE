...
// Preset variables
var refconDataPath = "tabular/eve/parvovirinae/epv-dependo-refseqs-side-data.tsv";
...
glue.inMode("module/tabularUtility", function() {
	loadResult1 = glue.tableToObjects(glue.command(["load-tabular", "tabular/eve/parvovirinae/epv-dependo-side-data.tsv"]));
